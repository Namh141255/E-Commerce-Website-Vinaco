                        ...
                        <div class="u-s-m-b-15">
                            <form name="addToCart" id="addToCart" class="pd-detail__form" action="javascript:;">
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <span class="pd-detail__label u-s-m-b-8">STYLE:</span>
                                        ...
                                        <div class="pd-table gl-scroll">
                                            <table>
                                                <tbody>
                                                    ...
                                                    @endif
                                                    @if(!empty($productDetails['layers']))
                                                    <tr>
                                                        <td>Layers</td>
                                                        <td>{{$productDetails['layers']}}</td>
                                                    </tr>
                                                    @endif
                                                    @if(!empty($productDetails['shape']))
                                                    <tr>
                                                        <td>Shape</td>
                                                        <td>{{$productDetails['shape']}}</td>
                                                    </tr>
                                                    @endif
                                                    ...
                                                    @endif
                                                    @if(!empty($productDetails['pieces']))
                                                    <tr>
                                                        <td>Pieces</td>
                                                        <td>{{$productDetails['pieces']}}</td>
                                                    </tr>
                                                    @endif
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section__text-wrap">
                            ...
                            <span class="section__span u-c-grey">PRODUCTS THAT YOPU ALSO LIKE TO BUY</span>
                        </div>
                    </div>
                </div>
            </div>
