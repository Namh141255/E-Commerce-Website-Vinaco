                    ...
                    <ul class="shop-w__list gl-scroll">
                        <li>
                            <div class="color__check">
                                ...
                                <label class="color__check-label" for="jet" style="background-color: #FF0000" title="Red"></label></div>Red
                        ...
                        <li>
                            <div class="color__check">
                                ...
                                <label class="color__check-label" for="folly" style="background-color: #0000FF"></label></div>Blue
                        ...
                        <li>
                            <div class="color__check">
                                ...
                                <label class="color__check-label" for="yellow" style="background-color: #FFFF00"></label></div>Yellow
                        ...
                        <li>
                            <div class="color__check">
                                ...
                                <label class="color__check-label" for="granite-gray" style="background-color: #008000"></label></div>Green
                        ...
                        <li>
                            <div class="color__check">
                                ...
                                <label class="color__check-label" for="space-cadet" style="background-color: #FFA500"></label></div>Orange
                        ...
                        <li>
                            ...
                            <div class="check-box">
                                ...
                                <div class="check-box__state check-box__state--primary">
                                    ...
                                    <label class="check-box__label" for="xs">Cotton</label></div>
                            </div>
                            <!--====== End - Check Box ======-->
                        </li>
                        <li>
                            ...
                            <div class="check-box">
                                ...
                                <div class="check-box__state check-box__state--primary">
                                    ...
                                    <label class="check-box__label" for="small">Polyester</label></div>
                            </div>
                            <!--====== End - Check Box ======-->
                        </li>
                        <li>
                            ...
                            <div class="check-box">
                                ...
                                <div class="check-box__state check-box__state--primary">
                                    ...
                                    <label class="check-box__label" for="medium">Wool</label></div>
                            </div>
                            <!--====== End - Check Box ======-->
                        </li>
