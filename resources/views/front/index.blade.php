...
<div class="app-content">
    ...
    <div class="s-skeleton s-skeleton--h-600 s-skeleton--bg-grey">
        <div class="owl-carousel primary-style-1" id="sitemakers-slider">
            ...
            <div class="sitemakers-slide sitemakers-slide--1" style="background-image: url('{{ asset('front/images/banners/'.$sliderBanner['banner_image']) }}');">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider-content slider-content--animation">

                                <span class="content-span-2 u-c-secondary">10% Off</span>
        ...
        <div class="section__content">
            <div class="container">
                ...
                @foreach($homeFixBanners as $fixBanner)
                    @if(isset($fixBanner['banner_image']))
                    <div class="col-lg-6 col-md-6 u-s-m-b-30">
                        <a class="collection" href="{{ $fixBanner['link'] }}" title="{{ $fixBanner['title'] }}">
                            <div class="aspect aspect--bg-grey aspect--square">
                                <img class="aspect__img collection__img" src="{{ asset('front/images/banners/'.$fixBanner['banner_image']) }}" 
                                alt="{{ $fixBanner['alt'] }}">
                            </div>
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="filter-category-container">
                            ...
                            <div class="filter__category-wrapper">
                                <button class="btn filter__btn filter__btn--style-1" type="button" data-filter=".newarrivals">NEW PRODUCTS</button>
                            </div>
                            <div class="filter__category-wrapper">
