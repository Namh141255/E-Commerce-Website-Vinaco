...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <a style="max-width: 150px; float:right; display: inline-block;" href="{{ url('admin/add-edit-banner')}}" 
            ...
            <table id="categories" class="table table-bordered table-striped">
                ...
                <tr>
                <td>{{ $banner['id']}}</td>
                <td><a target="_blank" href="{{ url('front/images/banners/'.$banner['banner_image']) }}">
                <img style="width: 180px;" src="{{ asset('front/images/banners/'.$banner['banner_image']) }}"></a></td>
                <td>{{ $banner['type']}}</td>
                <td>{{ $banner['link']}}</td>
                <td>{{ $banner['title']}}</td>
                <td>
                    ...
                    @endif
                    @if($bannersModule['edit_access']==1 || $bannersModule['full_access']==1)
                        <a style="color:#3f6ed3;" href="{{ url('admin/add-edit-banner/'.$banner['id']) }}"><i class="fas fa-edit"></i></a>
                        &nbsp;&nbsp;
                    @endif
