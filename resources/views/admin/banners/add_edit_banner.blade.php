                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    @if(!empty($banner['banner_image']))
                      <a target="_blank" href="{{ url('front/images/banners/'.$banner['banner_image']) }}">
                        <img style="width: 80px; margin: 10px;" src="{{ asset('front/images/banners/'.$banner['banner_image']) }}">
                      </a>
                    @endif
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="link" name="link" placeholder="Enter Banner Link" @if(!empty($banner['link'])) 
                    value="{{ $banner['link']}}" @else value="{{ old('link') }}"@endif>
                  </div>   
                  <div class="form-group">
                    <label for="sort">Banner Sort*</label>
                    <input type="number" class="form-control" id="sort" name="sort" placeholder="Enter Banner Sort" @if(!empty($banner['sort'])) 
                    value="{{ $banner['sort']}}" @else value="{{ old('sort') }}"@endif>
                  </div>           
                </div>
                <!-- /.card-body -->
